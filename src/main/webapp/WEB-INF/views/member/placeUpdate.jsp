			...
			<tbody>
				<tr>
					...
					<td id="td_place" style="text-align: left;">
						...
						<span style="margin: 0 16px; line-height: 3.4em !important;">  어쩌구 저쩌구 숙소입니다 짱짱 </span>
					</td>
					<td>4</td>
					<td>2</td>
					<td>1</td>
					...
					<td><svg viewBox="0 0 32 32" role="img" aria-label="ff 옵션" focusable="false" style="height: 18px; width: 18px; fill: rgb(118, 118, 118);"><path d="m1.5 16.5a3.5 3.5 0 117 0 3.5 3.5 0 01-7 0zm14.5 3.5a3.5 3.5 0 100-7 3.5 3.5 0 000 7zm11 0a3.5 3.5 0 100-7 3.5 3.5 0 000 7z" fill-rule="evenodd"></path></svg></td>
				</tr>
				<tr>
					<td>1</td>
					<td id="td_place" style="text-align: left;">
