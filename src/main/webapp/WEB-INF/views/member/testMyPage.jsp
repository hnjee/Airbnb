...
<body>
	...
	<div class="mwt4r90">
		<div class="_1m936jew ">
			<div class="_15wuypg">
				<a href="/account-settings/personal-info" class="_1cvdx4x"><div>
						<div style="margin-bottom: 16px;">
							<svg viewBox="0 0 24 24" role="presentation"
								style="height: 32px; width: 32px; display: block; fill: rgb(96, 182, 181);">
							<path
...
s
							...
							<div class="_ni9axhe">
								<div>
									<div>
										...
										<div class="_36rlri"
											style="vertical-align: middle; margin-top: -2px; margin-left: 4px;">
		...
		<div class="_1m936jew">
			<div class="_15wuypg">
				<a href="/account-settings/login-and-security" class="_1cvdx4x"><div>
						<div style="margin-bottom: 16px;">
							<svg viewBox="0 0 24 24" role="presentation"
						...
						<div class="_djxl322">
							<div class="_ni9axhe">
								<div>
									<div>
										<div class="_36rlri">
											<span class="_1p0spma2">로그인 및 보안</span>
										</div>
										<div class="_36rlri"
											style="vertical-align: middle; margin-top: -2px; margin-left: 4px;">
					...
					<div>
						<div class="_1xc0f9k">
							<div class="_czm8crp">비밀번호를 변경하고 계정을 안전하게 보호하세요</div>
						</div>
					</div></a>
			</div>
		</div>
		...
		<div class="_1m936jew">
			<div class="_15wuypg">
				<a href="/account-settings/payments/payment-methods"
					class="_1cvdx4x"><div>
						<div style="margin-bottom: 16px;">
							<svg viewBox="0 0 24 24" role="presentation"
								style="height: 32px; width: 32px; display: block; fill: rgb(96, 182, 181);">
					...
					<div>
						<div class="_1xc0f9k">
							<div class="_czm8crp">결제, 대금 수령, 쿠폰, 기프트카드 및 세금 검토하기</div>
						</div>
					</div></a>
			</div>
		</div>
		...
		<div class="_1m936jew">
			<div class="_15wuypg">
				<a href="/account-settings/notifications" class="_1cvdx4x"><div>
						<div style="margin-bottom: 16px;">
							<svg viewBox="0 0 24 24" role="presentation"
								style="height: 32px; width: 32px; display: block; fill: rgb(255, 180, 0);">
																		<path
					...
					<div>
						<div class="_1xc0f9k">
							<div class="_czm8crp">알림 환경설정 및 연락 방식을 선택하세요</div>
						</div>
					</div></a>
			</div>
		</div>
		...
		<div class="_1m936jew">
			<div class="_15wuypg">
				<a href="/account-settings/professional-hosting" class="_1cvdx4x"><div>
						<div style="margin-bottom: 16px;">
							<svg viewBox="0 0 26 24" role="presentation"
								style="height: 32px; width: 32px; display: block; fill: rgb(96, 182, 181);">
																		<path
						...
						<div class="_djxl322">
							<div class="_ni9axhe">
								<div>
									<div>
										<div class="_36rlri">
											<span class="_1p0spma2">전문 호스팅 도구</span>
										</div>
										<div class="_36rlri"
											style="vertical-align: middle; margin-top: -2px; margin-left: 4px;">
											<svg viewBox="0 0 18 18" role="presentation"
					...
					<div>
						<div class="_1xc0f9k">
							<div class="_czm8crp">에어비앤비에서 여러 숙소를 관리하신다면 전문 도구를 이용해보세요.</div>
						</div>
					</div></a>
			</div>
		</div>
