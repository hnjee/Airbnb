		...
		<div class="_3hmsj">
			<nav class="_vuzcgs">
				<div class="_w2q1b8">
					...
					<div class="_1ubw29">
						<button type="button" class="_547li01" aria-expanded="false"
							aria-label="언어와 통화">
							<div class="_iglww7">
								<div class="_z5mecy" aria-hidden="true">
									...
									<div>
										<svg width="9" height="6" viewBox="0 0 9 6" fill="none"
											style="display: block;">
										<path d="M1 1L4.5 4.5L8 1" stroke="currentcolor"
						...
						<div class="_hxlt5h" tabindex="-1" id="simple-header-locale-menu">
							...
							</a> <a class="_1ncnxsuh" href="/" data-no-client-routing="">
								<div class="_3hmsj">
					...
					<c:if test="${empty member}">
						<input type="button" class="_547li01" value="숙소 호스트 되기"
							id="memberLogin2">
					</c:if>
					...
					<a class="_547li01" href="/help" data-no-client-routing=""
						id="field-guide-toggle">
						<div class="_iglww7">도움말</div>
					</a>

					<c:if test="${empty member}">
						<input type="button" class="_547li01" value="회원 가입"
							id="memberJoin">
					</c:if>
				...
				<div>
					...
					<c:if test="${not empty member}">
						<div class="btn-group">
							<button type="button" class="_sxo1l2o dropdown-toggle"
								data-toggle="dropdown" id="idClick">${member.name}</button>
