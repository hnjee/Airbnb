...
<div class="_1g0fgis">
	...
	<div>
		<div class="_e296pg">
			<a href="./" class="_j1qvyg"><div class="_16j95sv9"
					style="width: 33.3%; left: 0%; max-width: 100%;">
					<div class="_121z06r2">숙소 유형</div>
				</div></a><a href="./" class="_j1qvyg"><div class="_1ut2fl4"
					style="width: 33.3%; left: 16.6667%; max-width: 83.3333%;">
					<div class="_121z06r2">숙소 주소</div>
				</div></a><a href="./" class="_j1qvyg"><div class="_1ut2fl4"
					style="width: 33.3%; left: 33.3333%; max-width: 66.6667%;">
					<div class="_121z06r2">숙소 상세정보</div>
				</div></a><a href="./" class="_j1qvyg"></a>
		</div>
	</div>
	<div class="_1mie2qk8">
		<div class="_13dmhdhf"
			style="width: 33.3%; left: 0%; max-width: 100%;"></div>
		<div class="_13dmhdhf"
			style="width: 33.3%; left: 33.4%; max-width: 66.7%;"></div>
		<div class="_13dmhdhf"
			style="width: 33.3%; left: 66.7%; max-width: 33.4%;"></div>
	</div>
</div>