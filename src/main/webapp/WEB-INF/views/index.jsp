					...
					<li>
						<div class="c2">
							<div class="c2img"> 
								...
								<div class="_h1esue" style="background-color: rgb(255, 255, 255); color: rgb(34, 34, 34);">NEW</div>							
							</div>
							<div class="c2txt"> 
								<div>
			...
			<div id="c3_content">
				<div id="c3txt">
					<div id="c3txt_1">
						<h1>온라인 체험 소개</h1>
						<div>
							세계 각지의 사람들과 새로운 것에 도전해보세요. 호스트가<br>진행하는 실시간 영상 세션을 통해 이제 집에서도 안전하게<br>체험을 즐기실 수 있습니다.
						</div>
					</div>
					<div id="c3txt_2">
						<a>모두 둘러보기</a>
					...
					<div id="c3pic_1"> 
						<div id="c3pic_1_pic">
							<img aria-hidden="true"
							 ...
							 data-original-uri="https://a0.muscache.com/im/pictures/0049c173-7313-42c5-9330-543ed4cb8d7d.jpg?aki_policy=large" 
							 style="object-fit: cover; border-radius: 16px; width: 792px; height: 792px;">
						</div>
						<div id="c3pic_1_txt">
							리스본에 사는 페드로와 비밀의<br>샹그리아를 만들어보세요.
						</div>
					</div>
					<div id="c3pic_2"> 
						<div id="c3pic_2_pic">
							<img aria-hidden="true" 
							src="https://a0.muscache.com/im/pictures/5bf46c77-4312-41b6-b9ad-66db5bbadd27.jpg?im_w=720" 
							data-original-uri="https://a0.muscache.com/im/pictures/5bf46c77-4312-41b6-b9ad-66db5bbadd27.jpg?aki_policy=large" 
							style="object-fit: cover; border-radius: 16px; width: 388px; height: 388px;">
						
						</div>
						<div id="c3pic_2_txt">
							스트레칭을 하고, 호흡을 가다듬고, 긴장을<br>풀어보세요. 친구와 함께하는 요가 클래스.
						</div>
					</div>
					<div id="c3pic_3"> 
						<div id="c3pic_3_pic">
						<img aria-hidden="true" 
						src="https://a0.muscache.com/im/pictures/5bd2705a-a565-426e-b928-f2a2b581e717.jpg?im_w=720" 
						data-original-uri="https://a0.muscache.com/im/pictures/5bd2705a-a565-426e-b928-f2a2b581e717.jpg?aki_policy=large" 
						style="object-fit: cover; border-radius: 16px; width: 388px; height: 388px;">
						</div>
						<div id="c3pic_3_txt">
							암스테르담에 사는 제니스와 함께 음악을<br>들으며 명상하기
						</div>
					</div>
					<div id="c3pic_4"> 
						<div id="c3pic_4_pic">
						<img aria-hidden="true" 
						src="https://a0.muscache.com/im/pictures/af46112a-b342-45bb-89b0-57fce44e110c.jpg?im_w=720" 
						data-original-uri="https://a0.muscache.com/im/pictures/af46112a-b342-45bb-89b0-57fce44e110c.jpg?aki_policy=large" 
						style="object-fit: cover; border-radius: 16px; width: 792px; height: 396px;">
						</div>
						<div id="c3pic_4_txt">
							존과 함께 그림 그리며 아프리카 펭귄에게 <br> 도움의 손길 보내기
						</div>
					</div>
				</div>
			</div>
		...
		<div id="contents4">
			<div id="c4_topBtm">
				<div id="c4_content">
					<div id="c4left">
						<div id="c4lefttop">
						   <h1 tabindex="-1">최전선에서 싸우는 구호<br>인력에게 숙소를 제공하는<br>에어비앤비의 <br>노력에 동참해주세요.</h1>
						</div>
						<div id="c4leftbtm">
							동참하기
						</div>
					...
					<div id="c4right">
						<div>
							코로나19와 맞서 싸우는 보건의료 인력, 긴급 구호 요원, 응급 구조 요원 등 10만 명에게 임시 숙소를 제공하는 '구호 인력을 위한 숙소' 프로그램에 에어비앤비 호스트 여러분의 참여를 부탁드립니다. 이는 감염 노출 위험이 있는 구호 인력에게 병원과 가까우면서도 가족과 떨어져 안전하게 머물 수 있는 숙소를 제공하기 위한 것입니다.
						</div>
					</div>
				</div>
			</div>
				...
				<div id="c5_content">
					...
					<div>
						...
						<section class="c5">
							...
							<div class="c5_wrap">
								<div class="c5_tit">
									<b>브라이언 체스키 CEO의 메세지</b>
								</div>
								<div class="c5_sub">
									에어비앤비 CEO의 영상 메세지 보기
								</div>
							</div>
							<div class="c5_wrap">
								<div class="c5_tit">
	...
	<footer>
		...
		<div id="footer2">
			...
			<!-- <div id="footer2_div2">
				...
				<span>KRW</span>
				<ul>
					<li><a rel="noopener noreferrer" target="_blank" href="https://www.facebook.com/AirbnbKorea"><svg viewBox="0 0 32 32" role="img" aria-label="페이스북으로 이동하기" focusable="false" style="height:18px;width:18px;display:block;fill:currentColor"><path d="m8 14.41v-4.17c0-.42.35-.81.77-.81h2.52v-2.08c0-4.84 2.48-7.31 7.42-7.35 1.65 0 3.22.21 4.69.64.46.14.63.42.6.88l-.56 4.06c-.04.18-.14.35-.32.53-.21.11-.42.18-.63.14-.88-.25-1.78-.35-2.8-.35-1.4 0-1.61.28-1.61 1.73v1.8h4.52c.42 0 .81.42.81.88l-.35 4.17c0 .42-.35.71-.77.71h-4.21v16c0 .42-.35.81-.77.81h-5.21c-.42 0-.8-.39-.8-.81v-16h-2.52a.78.78 0 0 1 -.78-.78" fill-rule="evenodd"></path></svg></a></li>
					<li><a rel="noopener noreferrer" target="_blank" href="https://twitter.com/airbnb"><svg viewBox="0 0 32 32" role="img" aria-label="트위터로 이동하기" focusable="false" style="height:18px;width:18px;display:block;fill:currentColor"><path d="m31 6.36c-1.16.49-2.32.82-3.55.95 1.29-.76 2.22-1.87 2.72-3.38a13.05 13.05 0 0 1 -3.91 1.51c-1.23-1.28-2.75-1.94-4.51-1.94-3.41 0-6.17 2.73-6.17 6.12 0 .49.07.95.17 1.38-4.94-.23-9.51-2.6-12.66-6.38-.56.95-.86 1.97-.86 3.09 0 2.07 1.03 3.91 2.75 5.06-1-.03-1.92-.3-2.82-.76v.07c0 2.89 2.12 5.42 4.94 5.98-.63.17-1.16.23-1.62.23-.3 0-.7-.03-1.13-.13a6.07 6.07 0 0 0 5.74 4.24c-2.22 1.74-4.78 2.63-7.66 2.63-.56 0-1.06-.03-1.43-.1 2.85 1.84 6 2.76 9.41 2.76 7.29 0 12.83-4.01 15.51-9.3 1.36-2.66 2.02-5.36 2.02-8.09v-.46c-.03-.17-.03-.3-.03-.33a12.66 12.66 0 0 0 3.09-3.16" fill-rule="evenodd"></path></svg></a></li>
					<li><a rel="noopener noreferrer" target="_blank" href="https://instagram.com/airbnb"><svg viewBox="0 0 24 24" role="img" aria-label="인스타그램으로 이동하기" focusable="false" style="height:18px;width:18px;display:block;fill:currentColor"><path d="m23.09.91c-.61-.61-1.33-.91-2.17-.91h-17.84c-.85 0-1.57.3-2.17.91s-.91 1.33-.91 2.17v17.84c0 .85.3 1.57.91 2.17s1.33.91 2.17.91h17.84c.85 0 1.57-.3 2.17-.91s.91-1.33.91-2.17v-17.84c0-.85-.3-1.57-.91-2.17zm-14.48 7.74c.94-.91 2.08-1.37 3.4-1.37 1.33 0 2.47.46 3.41 1.37s1.41 2.01 1.41 3.3-.47 2.39-1.41 3.3-2.08 1.37-3.41 1.37c-1.32 0-2.46-.46-3.4-1.37s-1.41-2.01-1.41-3.3.47-2.39 1.41-3.3zm12.66 11.63c0 .27-.09.5-.28.68a.92.92 0 0 1 -.67.28h-16.7a.93.93 0 0 1 -.68-.28.92.92 0 0 1 -.27-.68v-10.13h2.2a6.74 6.74 0 0 0 -.31 2.05c0 2 .73 3.71 2.19 5.12s3.21 2.12 5.27 2.12a7.5 7.5 0 0 0 3.75-.97 7.29 7.29 0 0 0 2.72-2.63 6.93 6.93 0 0 0 1-3.63c0-.71-.11-1.39-.31-2.05h2.11v10.12zm0-13.95c0 .3-.11.56-.31.77a1.05 1.05 0 0 1 -.77.31h-2.72c-.3 0-.56-.11-.77-.31a1.05 1.05 0 0 1 -.31-.77v-2.58c0-.29.11-.54.31-.76s.47-.32.77-.32h2.72c.3 0 .56.11.77.32s.31.47.31.76z" fill-rule="evenodd"></path></svg></a></li>
